# 24. HIPAA Mappings to Ycorp Controls

Below is a list of HIPAA Safeguards and Requirements and the Ycorp controls in place to meet those.

| **Administrative Controls** HIPAA Rule | Ycorp Control
--- | ---
...
| **Physical Safeguards** HIPAA Rule | Ycorp Control
--- | ---
...
| **Technical Safeguards** HIPAA Rule | Ycorp Control
---------------- | ----------------
